...
if(!CModule::IncludeModule("iblock"))
	...
	$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/6_brands.xml";
	$iblockCode = "STARTUP_BRANDS_".WIZARD_SITE_ID;
	$iblockType = "STARTUP"; 
...
if ($PageView == "longread") {
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("BRANDS_CODE" => $brands_code));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("STARTUP_BRANDS_ID" => $iblockID));
}
elseif ($PageView == "pages") {
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("BRANDS_CODE" => ""));

	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."testimonial/index.php", array("STARTUP_BRANDS_ID" => $iblockID));
}
