...
if(!CModule::IncludeModule("iblock"))
	...
	$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/5_quotes.xml";
	$iblockCode = "STARTUP_QUOTES_".WIZARD_SITE_ID;
	$iblockType = "STARTUP"; 
...
if ($PageView == "longread") {
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("QUOTES_CODE" => $quotes_code));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("STARTUP_QUOTES_ID" => $iblockID));
...
elseif ($PageView == "pages") {
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("QUOTES_CODE" => ""));

	$folderby = $_SERVER["DOCUMENT_ROOT"]."/bitrix/wizards/coffeediz/Startup/site/services/iblock/lang/ru/include/testimonial";
	$folderto = WIZARD_SITE_PATH."testimonial";
	CopyDirFiles(
		$folderby,
		$folderto,
		$rewrite = true,
	...
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."testimonial/index.php", array("STARTUP_QUOTES_ID" => $iblockID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."testimonial/index.php", array("SLIDER_ABOUT_TITLE" => GetMessage("SLIDER_ABOUT_TITLE")));
}
