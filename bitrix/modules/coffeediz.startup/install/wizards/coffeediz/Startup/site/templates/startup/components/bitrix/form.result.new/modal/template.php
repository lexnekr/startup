...
<?if (!empty($arResult["FORM_NOTE"]) or $arResult["isFormErrors"] == "Y"):?>
    ...
    <div style="top: 40%" id="bs-feadbeck-modal-sm" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="false">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?else:?>
                        <?if (!empty($arParams["RESULT_TEXT"])):?><?=$arParams['RESULT_TEXT'];?><?else:?><?=GetMessage('RESULT_TEXT_DEFAULT');?><?endif?>
                    <?endif?>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function(){
            $("#bs-feadbeck-modal-sm").modal("show");
        })
    </script>
<?endif?>
